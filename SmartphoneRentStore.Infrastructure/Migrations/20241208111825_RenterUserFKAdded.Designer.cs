...
namespace SmartphoneRentStore.Infrastructure.Migrations
{
    ...
    [Migration("20241208111825_RenterUserFKAdded")]
            ...
            modelBuilder.Entity("SmartphoneRentStore.Infrastructure.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f073898e-730d-4417-89e1-6f61fb42cd2f",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEDTOd6x3s+zL2WujdKVcxqHhRCK5WfVhhOqTMYsojvLjlcFhmuyzhx3neJJilg2s3w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "637e630e-d358-4720-8546-7a32908e9d6c",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "959c6d4b-04d7-42a8-a5dc-87b0af9e66f8",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEChJA27bHJF60zY0LBClDVs22VU1mBxCySKnugSQMtE1IWSru0YUnPd8bG6lhlJWAA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "cad1cf61-ffa5-4434-a99e-c6637c03176b",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b8dd17c7-a593-4605-af60-806140c69245",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEA0oTbouPRIpWj33D37zqe8yGB8+KPwFj94xUUI59bIBynxB/cMNzSwyKDtUXvEecw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "b3d9306c-67a0-464a-9488-6f3e78a5414c",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("SmartphoneRentStore.Infrastructure.Data.Models.SmartPhone", b =>
                {
                    ...
                    b.HasOne("SmartphoneRentStore.Infrastructure.Data.Models.ApplicationUser", "Renter")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartphoneRentStore.Infrastructure.Data.Models.Supplier", b =>
                {
                    b.HasOne("SmartphoneRentStore.Infrastructure.Data.Models.ApplicationUser", "User")
                        .WithOne("Supplier")
                        .HasForeignKey("SmartphoneRentStore.Infrastructure.Data.Models.Supplier", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
